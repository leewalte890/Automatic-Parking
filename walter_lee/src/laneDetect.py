...
class LogRegression:
    ...
    def display_compressed(self, data):
        ...
        try:
            ...
            pass
        if len(nCentroids) > 0:
            cv2.circle(fProb,(int(nCentroids[cIndex][0]),int(nCentroids[cIndex][1])),3,(0,255,255),-1)
...
if __name__ == "__main__":
    ...
    path1 = os.path.join(dire,'Arc1.png')
    path2 = os.path.join(dire,'Arc1_mask.png')
